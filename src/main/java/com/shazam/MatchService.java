...
public class MatchService {
    ...
    public static List<Song> getRequiredAmountOfSongs(List<Song> songs, int numTopRatedSimilarSongs){
        return songs.stream().limit(numTopRatedSimilarSongs).collect(Collectors.toList());
    }

    public static List<Song> getSortedSongs(List<Song> songs){
    ...
    public static List<Song> getSongsInNetwork(Song song, List<Song> songs) {
